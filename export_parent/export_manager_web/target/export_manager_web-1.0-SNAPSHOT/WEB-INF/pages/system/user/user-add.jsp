    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/system/user/edit.do" method="post">
                ...
                <input type="hidden" id="deptName" name="deptName" value="${requestScope.user.deptName}">
                <div class="row data-type" style="margin: 0px">
                    <div class="col-md-2 title">用户名称</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="用户名称" name="userName" value="${requestScope.user.userName}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="邮箱" name="email" value="${requestScope.user.email}">
                    </div>

                    <div class="col-md-2 title">密码</div>
                    <div class="col-md-4 data">
                        <input type="password" class="form-control" placeholder="密码" name="password" value="${requestScope.user.password}">
                    </div>

                    <div class="col-md-2 title">薪水</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="薪水" name="salary" value="${requestScope.user.salary}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline">
                            ...
                            <div class="radio"><label><input type="radio" ${requestScope.user.state==1?'checked':''} name="state" value="1">启用</label></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="岗位" name="station" value="${requestScope.user.station}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="排序号" name="orderNo" value="${requestScope.user.orderNo}">
                    </div>

                    <div class="col-md-2 title">等级</div>
                    <div class="col-md-10 data">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${requestScope.user.degree==1?'checked':''} name="degree" value="1">系统管理员</label></div>
                            <div class="radio"><label><input type="radio" ${requestScope.user.degree==2?'checked':''} name="degree" value="2">管理所有下属部门和人员</label></div>
                            <div class="radio"><label><input type="radio" ${requestScope.user.degree==3?'checked':''} name="degree" value="3">管理本部门</label></div>
                            <div class="radio"><label><input type="radio" ${requestScope.user.degree==4?'checked':''} name="degree" value="4">普通员工</label></div>
                        </div>
                    </div>

                    <div class="col-md-2 title">说明</div>
                    <div class="col-md-10 data">
                        <input type="text" class="form-control" placeholder="说明" name="remark" value="${requestScope.user.remark}">
                    </div>
                </div>
            </form>
        </div>
